...
import { getEnrolledCourses } from "@workspace/sanity-utils/groq/student/getEnrolledCourses";
import Link from "next/link";
import { GraduationCap } from "lucide-react";
import { getCourseProgress } from "@workspace/sanity-utils/groq/lessons/getCourseProgress";
...
export default async function MyCoursesPage() {
  ...
  const coursesWithProgress = await Promise.all(
    enrolledCourses.map(async (enrollment) => {
      ...
      const progress = await getCourseProgress(user.id, enrollment.course._id);
      return {
