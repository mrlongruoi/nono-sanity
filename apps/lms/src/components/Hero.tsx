            ...
            <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
                <div className="max-w-3xl">
                    <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">
                        Mở rộng kiến thức của bạn với các khóa học của chúng tôi
                    </h1>

                    <p className="text-xl text-muted-foreground">
                        Khám phá thế giới học tập với các khóa học được thiết kế chuyên nghiệp của chúng tôi.
                        Học hỏi từ các chuyên gia trong ngành và nâng cao kỹ năng của bạn lên một tầm cao mới.
                    </p>
                </div>
            </div>
        </div>
