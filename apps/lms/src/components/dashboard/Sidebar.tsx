...
export function Sidebar({ course, completedLessons = [] }: Readonly<SidebarProps>) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <button
          className="fixed inset-0 z-30 bg-background/80 backdrop-blur-sm lg:hidden cursor-default"
          onClick={close}
